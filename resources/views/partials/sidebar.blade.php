...
<nav class="flex-grow px-4 space-y-2">
    ...
    <a href="{{ route('admin.reports.index') }}" 
       class="flex items-center space-x-3 p-4 rounded-2xl transition font-medium {{ (request()->routeIs('admin.reports.index') || request()->routeIs('admin.reports.sales')) ? 'bg-white/10 border border-white/10 shadow-sm text-white' : 'text-indigo-100 hover:bg-white/5' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
    ...
    <a href="{{ route('admin.reports.finance') }}" 
       class="flex items-center space-x-3 p-4 rounded-2xl transition font-medium {{ (request()->routeIs('admin.reports.finance*') || request()->routeIs('admin.reports.qris*')) ? 'bg-white/10 border border-white/10 shadow-sm text-white' : 'text-indigo-100 hover:bg-white/5' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
    ...
    <a href="{{ route('admin.users.index') }}" 
       class="flex items-center space-x-3 p-4 rounded-2xl transition font-medium {{ request()->routeIs('admin.users.*') ? 'bg-white/10 border border-white/10 shadow-sm text-white' : 'text-indigo-100 hover:bg-white/5' }}">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
