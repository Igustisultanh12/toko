...
<div class="max-w-6xl mx-auto pb-20 space-y-8">
    ...
    {{-- NOTIFIKASI SUKSES --}}
    @if(session('success'))
        <div class="p-5 bg-emerald-50 border-l-8 border-emerald-500 text-emerald-800 font-bold rounded-r-3xl shadow-sm flex items-center">
            <svg class="w-6 h-6 mr-3 text-emerald-500 shrink-0" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
    ...
    {{-- NOTIFIKASI ERROR --}}
    @if($errors->any())
        <div class="p-5 bg-rose-50 border-l-8 border-rose-500 text-rose-800 font-bold rounded-r-3xl shadow-sm">
            <p class="uppercase text-xs font-black mb-2">Terdeteksi Kesalahan Input:</p>
    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            {{-- SEKSI 1: BRANDING & IDENTITAS APLIKASI (NAMA SIKANDA & FAVICON) --}}
            <div class="bg-white rounded-[3rem] shadow-xl border border-gray-100 p-8 sm:p-10 space-y-6">
                <div class="flex items-center space-x-4 border-b border-gray-100 pb-4">
                    <div class="bg-indigo-600 p-3.5 rounded-2xl text-white shadow-lg shadow-indigo-100">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-gray-900 uppercase tracking-tight">Branding & Nama Aplikasi</h3>
                        <p class="text-xs text-gray-400 font-medium">Ubah nama sistem (SIKANDA) dan favicon browser tab.</p>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="app_name" value="{{ $settings['app_name'] ?? 'SIKANDA' }}" 
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-indigo-500 focus:bg-white transition-all font-black text-gray-800 text-sm" placeholder="SIKANDA">
                    ...
                    <div>
                        ...
                        <input type="text" name="app_tagline" value="{{ $settings['app_tagline'] ?? 'Sultan Web Engine' }}" 
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-indigo-500 focus:bg-white transition-all font-bold text-gray-700 text-xs" placeholder="Sultan Web Engine">
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-3xl p-6 text-center bg-gray-50 hover:border-indigo-400 transition-all">
                            ...
                            @endif
                            <div>
                                <input type="file" name="app_favicon" accept=".ico,.png,.jpg,.jpeg,.svg" class="text-xs font-bold text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:bg-indigo-600 file:text-white file:font-black file:text-[10px] file:uppercase">
                            </div>
            ...
            <div class="bg-white rounded-[3rem] shadow-xl border border-gray-100 p-8 sm:p-10 space-y-6">
                <div class="flex items-center space-x-4 border-b border-gray-100 pb-4">
                    <div class="bg-emerald-600 p-3.5 rounded-2xl text-white shadow-lg shadow-emerald-100">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-gray-900 uppercase tracking-tight">Identitas Toko</h3>
                        <p class="text-xs text-gray-400 font-medium">Informasi toko yang tercetak pada nota & laporan.</p>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="shop_name" value="{{ $settings['shop_name'] ?? 'TOKO ANANDA' }}" required
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-emerald-500 focus:bg-white transition-all font-black text-gray-800 text-sm" placeholder="TOKO ANANDA">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="shop_phone" value="{{ $settings['shop_phone'] ?? '' }}" 
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-emerald-500 focus:bg-white transition-all font-bold text-gray-700 text-xs" placeholder="08123456789">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="shop_address" rows="2" 
                                  class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-emerald-500 focus:bg-white transition-all font-bold text-gray-700 text-xs">{{ $settings['shop_address'] ?? '' }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-3xl p-6 text-center bg-gray-50 hover:border-emerald-400 transition-all">
                            ...
                            @endif
                            <div>
                                <input type="file" name="shop_logo" accept="image/*" class="text-xs font-bold text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:bg-emerald-600 file:text-white file:font-black file:text-[10px] file:uppercase">
                            </div>
            ...
            <div class="bg-indigo-950 rounded-[3rem] shadow-2xl p-8 sm:p-10 space-y-6 text-white">
                <div class="flex items-center space-x-4 border-b border-indigo-900/80 pb-4">
                    <div class="bg-indigo-500 p-3.5 rounded-2xl text-white shadow-lg shadow-indigo-500/30">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="receipt_footer" value="{{ $settings['receipt_footer'] ?? 'Terima Kasih Telah Berbelanja!' }}" 
                               class="w-full p-4 bg-indigo-900/50 border-2 border-indigo-800 rounded-2xl outline-none focus:border-indigo-400 transition-all font-bold text-xs text-indigo-100" placeholder="Terima Kasih!">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[3rem] shadow-xl border border-gray-100 p-8 sm:p-10 space-y-6">
                <div class="flex justify-between items-center border-b border-gray-100 pb-4">
                    <div class="flex items-center space-x-4">
                        <div class="bg-amber-500 p-3.5 rounded-2xl text-white shadow-lg shadow-amber-100">
                        ...
                        <div>
                            <h3 class="text-lg font-black text-gray-900 uppercase tracking-tight">Notifikasi Suara Kasir</h3>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-200 rounded-3xl p-6 text-center bg-gray-50 hover:border-amber-400 transition-all space-y-3">
                            ...
                            @endif
                            <div>
                                <input type="file" name="payment_success_sound" accept="audio/*" class="text-xs font-bold text-gray-400 file:mr-4 file:py-2.5 file:px-4 file:rounded-xl file:border-0 file:bg-amber-600 file:text-white file:font-black file:text-[10px] file:uppercase">
                            </div>
            ...
            <div class="bg-white rounded-[3rem] shadow-xl border border-gray-100 p-8 sm:p-10 space-y-6 lg:col-span-2">
                <div class="flex items-center space-x-4 border-b border-gray-100 pb-4">
                    <div class="bg-teal-600 p-3.5 rounded-2xl text-white shadow-lg shadow-teal-100">
                    ...
                    <div>
                        <h3 class="text-lg font-black text-gray-900 uppercase tracking-tight">Tanda Tangan Elektronik (TTE) & Penanggung Jawab</h3>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="cashier_officer_title" value="{{ $settings['cashier_officer_title'] ?? 'Petugas Kasir' }}" 
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-teal-500 focus:bg-white transition-all font-bold text-gray-800 text-xs" placeholder="Contoh: Petugas Kasir / Kepala Toko">
                    ...
                    <div>
                        ...
                        <input type="text" name="cashier_officer_name" value="{{ $settings['cashier_officer_name'] ?? '' }}" 
                               class="w-full p-4 bg-gray-50 border-2 border-gray-100 rounded-2xl outline-none focus:border-teal-500 focus:bg-white transition-all font-bold text-gray-800 text-xs" placeholder="Kosongkan untuk otomatis nama kasir login">
                ...
                <div class="p-4 bg-teal-50 rounded-2xl border border-teal-100 flex items-center space-x-3 text-xs text-teal-800 font-medium">
                    <span class="text-lg">🛡️</span>
                    <span>Setiap faktur PDF akan dilengkapi **QR Code Tanda Tangan Elektronik (TTE)**. Ketika di-scan oleh pembeli, sistem akan membuka halaman verifikasi keabsahan dokumen dan identitas penanggung jawab transaksi.</span>
                </div>
            </div>
        ...
        <div class="flex items-center justify-end pt-6 border-t border-gray-200">
            <button type="submit" class="px-10 py-4 bg-indigo-600 hover:bg-indigo-700 active:scale-95 text-white font-black text-xs uppercase tracking-widest rounded-2xl shadow-xl shadow-indigo-100 transition flex items-center">
