...
<head>
    ...
    <title>Tambah Produk | SIKANDA Premium POS</title>
...
<body class="flex min-h-screen" x-data="productForm()">
    ...
    <main class="flex-grow flex flex-col h-screen overflow-hidden">
        ...
        <header class="bg-white/80 backdrop-blur-md p-6 border-b flex justify-between items-center px-10 sticky top-0 z-10 border-gray-100">
            <div>
                <h2 class="text-xl font-black text-gray-800 tracking-tighter uppercase leading-none">Entry Produk Baru</h2>
                <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">Lengkapi data barang</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-10">
                            ...
                            <div class="space-y-2 md:col-span-1">
                                ...
                                <div class="flex space-x-2">
                                    <input type="text" name="barcode" id="barcode" x-model="barcode" value="{{ old('barcode') }}"
                            ...
                            {{-- Stok --}}
                            <div class="space-y-2 md:col-span-1">
                                <label for="stock" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Stok Awal</label>
                            ...
                            <div class="space-y-2 md:col-span-2">
                                <label for="description" class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Deskripsi Produk (Opsional)</label>
                                <textarea name="description" id="description" rows="3" 
                                          class="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-[1.5rem] outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium text-gray-600 shadow-inner">{{ old('description') }}</textarea>
                            </div>
                        </div>

                        <div class="mt-14 pt-8 border-t border-gray-50 flex items-center justify-between">
                            <p class="text-[10px] text-gray-400 font-bold uppercase tracking-widest leading-none">Pastikan data sudah benar sebelum menyimpan.</p>
                            <button type="submit" 
    ...
    <div x-show="isScannerActive" class="fixed inset-0 z-[100] flex items-center justify-center p-6 overflow-hidden" x-cloak>
        ...
        <div class="bg-white rounded-[3rem] p-8 w-full max-w-lg relative z-10 shadow-2xl border border-white/20">
            ...
            <div id="admin-create-reader" class="w-full overflow-hidden rounded-[2rem] border-4 border-gray-100"></div>
