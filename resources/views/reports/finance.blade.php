...
<div class="max-w-7xl mx-auto space-y-6 pb-20">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-indigo-600 p-6 rounded-[2.5rem] shadow-xl text-white">
            <p class="text-[10px] font-bold text-indigo-200 uppercase tracking-widest mb-1">Total Pemasukan Kas (Lunas)</p>
        ...
        <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100">
            ...
            <h3 class="text-2xl font-black text-emerald-600">Rp {{ number_format($stats['cash_income'] ?? 0, 0, ',', '.') }}</h3>
            <p class="text-[10px] text-gray-400 mt-1 font-medium">Uang fisik di kasir</p>
        </div>

        {{-- Digital QRIS --}}
        <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Penerimaan Digital QRIS</p>
            <h3 class="text-2xl font-black text-indigo-600">Rp {{ number_format($stats['qris_income'] ?? 0, 0, ',', '.') }}</h3>
            <p class="text-[10px] text-gray-400 mt-1 font-medium">Rekening Merchant DOKU</p>
        </div>

        {{-- Pending --}}
        <div class="bg-white p-6 rounded-[2.5rem] shadow-sm border border-gray-100">
            <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Dana Belum Selesai (Pending)</p>
            <h3 class="text-2xl font-black text-orange-500">Rp {{ number_format($stats['pending_income'] ?? 0, 0, ',', '.') }}</h3>
            <p class="text-[10px] text-gray-400 mt-1 font-medium">{{ $stats['pending_count'] ?? 0 }} transaksi tertunda</p>
        </div>
    </div>
