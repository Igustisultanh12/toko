...
<div class="max-w-7xl mx-auto space-y-6 pb-20">
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-[2rem] border border-gray-100 shadow-sm">
        <div>
            ...
            <p class="text-xs text-gray-400 font-medium mt-0.5">Filter data harian, bulanan, 3 bulan (triwulan), atau tahunan dengan detail produk.</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
        <div class="p-6 sm:p-8 border-b border-gray-50 flex justify-between items-center">
            <div>
                ...
                <p class="text-xs text-gray-400 font-medium mt-0.5">Menampilkan seluruh data invoice, nama pelanggan, dan rincian produk yang dibeli.</p>
            </div>
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-50 text-xs">
                    ...
                    <tr class="hover:bg-indigo-50/20 transition-colors">
                        ...
                        <td class="p-5">
                            <span class="font-bold text-gray-800 bg-gray-100 px-2.5 py-1 rounded-lg">
