<table>
    ...
    <tr><td></td></tr>
    <tr><td colspan="7" style="text-align: center; font-weight: bold; text-decoration: underline;">LAPORAN TRANSAKSI QRIS</td></tr>
    <tr><td colspan="7" style="text-align: center; font-weight: bold;">Nomor: LPK / {{ date('m / Y') }} / SIKANDA</td></tr>
    <tr><td></td></tr>
    <thead>
        <tr>
            ...
            <th style="border: 1px solid black; background-color: #f2f2f2; font-weight: bold;">RINCIAN BARANG TERJUAL</th>
            <th style="border: 1px solid black; background-color: #f2f2f2; font-weight: bold;">TOTAL QTY</th>
    ...
    <tfoot>
        <tr>
            <td colspan="4" style="border: 1px solid black; font-weight: bold; text-align: center; background-color: #eeeeee;">TOTAL PEMASUKAN (SUKSES)</td>
            <td style="border: 1px solid black; font-weight: bold; text-align: center; background-color: #eeeeee;">{{ $totalQtySemua }}</td>
